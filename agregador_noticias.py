...
def fetch_and_format_news():
    ...
    for name, url in FEEDS.items():
        try:
            ...
            # Limita el número de artículos a procesar
...
def send_notification(message):
    ...
    try:
        # La corrección está en la sección de 'headers'
        requests.post(
            ...
            headers={
                ...
                "Tags": "newspaper,news",
                "Markdown": "yes",
                # La siguiente línea es la corrección clave para asegurar la codificación UTF-8
